                            ...
                            @foreach($assetsWithOwned as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{ route('assets.destroy', $asset) }}" style="display: inline;" onsubmit="return confirmAction(event, 'Are you sure you want to delete this asset?');">
                                            @csrf
                                            @method('DELETE')
