...
@section('content')
    ...
    <div class="card">
        ...
        @if($contactSubmission->admin_response)
            <div style="margin-bottom: 1.5rem; padding: 1rem; background: var(--soft-green-bg); border: 1px solid var(--success); border-radius: 6px;">
                <h3 style="margin-top: 0; color: var(--soft-green-text);">Admin Response</h3>
                <div style="white-space: pre-wrap; line-height: 1.6; color: var(--soft-green-text);">
